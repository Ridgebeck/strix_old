    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          message.image == null
              ? TextMessage(radius: radius, fromMe: fromMe, message: message, delay: delay)
              : delay
                  ? DelayedImageMessage(
                      radius: radius, fromMe: fromMe, message: message, delay: delay)
                  : ImageMessage(radius: radius, fromMe: fromMe, message: message, delay: delay),
          fromTeam
              ? fromMe
                  ? Container()
