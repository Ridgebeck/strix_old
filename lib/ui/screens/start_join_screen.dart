            ...
            child: Column(
              children: [
                ...
                Center(
                  child: GestureDetector(
                    onTap: () {},
                    child: BorderedButton(buttonText: 'How this works', fontSize: 20.0),
                  ),
                ),
                Expanded(child: Container()),
                Center(
                  child: GestureDetector(
                    ...
                    child: BorderedButton(buttonText: 'Start a Mission', fontSize: 20.0),
                  ),
                ),
                Expanded(child: Container()),
                Center(
                  child: GestureDetector(
                    ...
                    child: BorderedButton(buttonText: 'Join a Mission', fontSize: 20.0),
                  ),
                ),
